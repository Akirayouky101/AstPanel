-- ================================================
-- MIGRATION COMPLETA: Availability System
-- VERSIONE FINALE - Mostra TUTTI gli utenti (senza filtro ruolo)
...
-- 4. Funzione per dashboard disponibilità - MOSTRA TUTTI GLI UTENTI
...
BEGIN
    ...
    carico_corrente AS (
        ...
        -- NESSUN FILTRO SUI RUOLI - Mostra TUTTI
...
-- 5. Funzione per trovare dipendente più disponibile
...
BEGIN
    ...
    IF user_count = 0 THEN
        -- Nessun utente, restituisce riga vuota senza errore
        RETURN;
    END IF;
...
COMMENT ON FUNCTION get_dashboard_disponibilita IS 'Dashboard rapida disponibilità TUTTI gli utenti (SECURITY DEFINER, nessun filtro ruolo)';
...
-- 10. Cambia owner a postgres per garantire pieno accesso
...
-- VERIFICA AUTOMATICA
-- ================================================
SELECT '✅ Step 1: Verifica tabella creata' as step;
SELECT COUNT(*) as user_availability_count FROM user_availability;

SELECT '✅ Step 2: Verifica funzioni create' as step;
SELECT routine_name FROM information_schema.routines 
WHERE routine_schema = 'public' 
AND routine_name IN ('calcola_carico_lavoro', 'trova_dipendente_disponibile', 'get_dashboard_disponibilita', 'check_urgenza_veloce');

SELECT '✅ Step 3: Test dashboard (mostra TUTTI gli utenti)' as step;
SELECT * FROM get_dashboard_disponibilita();

SELECT '✅ Step 4: Test check veloce (utente più disponibile)' as step;
